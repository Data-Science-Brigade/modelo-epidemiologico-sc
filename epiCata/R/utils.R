...
clean_city_name_str <- function(txt){
  require(tidyverse)
  require(stringr)

 txt %>%
   str_to_upper %>%
   remove_accent_uppercase
}

remove_accent <- function(txt) {
  txt %>%
    remove_accent_lowercase %>%
    remove_accent_uppercase
}


remove_accent_lowercase <- function(txt)  {
  # Função alterada de uma função desenvolvida por Manoel Galdino <http://lattes.cnpq.br/9398710384205803>
  # e aprimorada por Davi Moreira <http://lattes.cnpq.br/7406586493977047>
  # Recebe: um vetor com strings
  # Operação: substitui caracteres com acentos em caixa baixa por caracteres sem acentos.
  # Retorna: um vetor
  require(tidyverse)
  require(stringr)
...
remove_accent_uppercase <- function(txt) {
  # Função alterada de uma função desenvolvida por Manoel Galdino <http://lattes.cnpq.br/9398710384205803>
  # e aprimorada por Davi Moreira <http://lattes.cnpq.br/7406586493977047>
  # Recebe: um vetor com strings
  # Operação: substitui caracteres em caixa alta com acentos por caracteres sem acentos.
  # Retorna: um vetor
  require(tidyverse)
  require(stringr)
